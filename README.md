...
**24 chapitres, 672 exercices**, sur 9 parcours : Java (8 chapitres), Spring Boot (6), Transverse (2), SQL et Postgres,
Architecture, Tests, Docker, React (3), Git et GitLab CI. Le programme complet est dans
