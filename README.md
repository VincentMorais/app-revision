...
**16 chapitres, 480 exercices**, sur 8 parcours : Java (6 chapitres), Spring Boot (4), SQL et Postgres,
...
`content/__tests__/content.test.ts`. Chapitre étalon : `content/java/interfaces-classes-abstraites.ts`.
